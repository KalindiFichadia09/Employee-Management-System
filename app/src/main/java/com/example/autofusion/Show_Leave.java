...
public class Show_Leave {
    private String Leave_Type,Leave_Category,Leave_Start_Date,Leave_End_Date,Leave_Remarks,Leave_Status;

    public Show_Leave(String Leave_Type, String Leave_Category,String Leave_Start_Date,String Leave_End_Date,String Leave_Remarks,String Leave_Status) {
