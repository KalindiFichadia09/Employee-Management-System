...
public class admin_show_employee extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] headerText = {"Email Name","Employee Email", "Employee Mobile","Employee Department"};
        ...
        CollectionReference outletRef = afdb.collection("Employee");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        String EmpEmail = document.getString("EmpCompanyEmail");
                        ...
                        row.setLayoutParams(new TableLayout.LayoutParams(TableLayout.LayoutParams.WRAP_CONTENT,
                                TableLayout.LayoutParams.WRAP_CONTENT));
                        String[] colText = {EmpName, EmpEmail,EmpMobile,EmpDepartment};
