...
public class user_Salary_Slip {
    private String Start_Date,End_Date;
    long Basic_Pay,Allowance,Deduction,Adjustment,Total_Pay;

    public user_Salary_Slip(String Start_Date, String End_Date, long Basic_Pay, long Allowance,long Deduction,long Adjustment,long Total_Pay) {
