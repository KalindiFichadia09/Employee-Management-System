...
public class admin_manage_leave extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] headerText = {"Leave Emp Email","Leave Type", "Leave Category","Leave Start Date","Leave End Date","Leave Remarks"};
        ...
        CollectionReference outletRef = afdb.collection("Leaves");
                ...
                if (task.isSuccessful()) {
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        row.setLayoutParams(new TableLayout.LayoutParams(TableLayout.LayoutParams.MATCH_PARENT,
                                TableLayout.LayoutParams.WRAP_CONTENT));
                        String[] colText = {leaveEmpEmail,leaveType,leaveCategory,leaveStartDate,leaveEndDate,leaveRemark};
